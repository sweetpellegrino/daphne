...
module {
  ...
  llvm.func @main() attributes {llvm.emit_c_interface} {
    ...
    %4 = llvm.mlir.constant(140729467558240 : ui64) : i64
    ...
    llvm.call @_incRef__Structure(%12, %8) : (!llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
    llvm.call @_ewAdd__DenseMatrix_double__DenseMatrix_double__double(%10, %12, %0, %8) : (!llvm.ptr<ptr<i1>>, !llvm.ptr<i1>, f64, !llvm.ptr<i1>) -> ()
    %14 = llvm.load %10 : !llvm.ptr<ptr<i1>>
    %15 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @_decRef__Structure(%12, %8) : (!llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
    %16 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @_incRef__Structure(%14, %8) : (!llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
    llvm.call @_ewSqrt__DenseMatrix_double__DenseMatrix_double(%10, %14, %8) : (!llvm.ptr<ptr<i1>>, !llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
    %17 = llvm.load %10 : !llvm.ptr<ptr<i1>>
    %18 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @_decRef__Structure(%14, %8) : (!llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
