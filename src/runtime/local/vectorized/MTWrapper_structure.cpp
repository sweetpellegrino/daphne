...
void MTWrapper<Structure>::executeCpuQueues(
        std::vector<std::function<MTWrapper<Structure>::PipelineFunc>> funcs, Structure ***res,
...
template class MTWrapper<Structure>;
