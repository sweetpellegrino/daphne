...
module {
  func.func @main() {
    ...
    %7 = "daphne.ewAdd"(%5, %6) : (!daphne.Matrix<?x?xsi64>, si64) -> !daphne.Matrix<?x?xsi64>
    %8 = "daphne.ewSqrt"(%7) : (!daphne.Matrix<?x?xsi64>) -> !daphne.Matrix<?x?xf64>
    "daphne.return"() : () -> ()
  }
}
%0 = "daphne.constant"() {value = 1 : si64} : () -> si64
...
//  - Operand produced by operation 'daphne.constant0x5624a2e17520'
//Has 1 results:
//  - Result 0 has a single use: 
//    - daphne.fill
%4 = "daphne.cast"(%2) : (si64) -> index
//Visiting op 'daphne.cast' with 1 operands:
//  - Operand produced by operation 'daphne.constant0x5624a2e20230'
//Has 1 results:
//  - Result 0 has a single use: 
//    - daphne.fill
%5 = "daphne.fill"(%0, %3, %4) : (si64, index, index) -> !daphne.Matrix<?x?xsi64>
//Visiting op 'daphne.fill' with 3 operands:
//  - Operand produced by operation 'daphne.constant0x5624a2e14790'
//  - Operand produced by operation 'daphne.cast0x5624a2e0ee50'
//  - Operand produced by operation 'daphne.cast0x5624a2e1a8c0'
//Has 1 results:
//  - Result 0 has a single use: 
//    - daphne.ewAdd
%6 = "daphne.constant"() {value = 1 : si64} : () -> si64
...
//  - Operand produced by operation 'daphne.fill0x5624a2e20750'
//  - Operand produced by operation 'daphne.constant0x5624a2e201d0'
//Has 1 results:
//  - Result 0 has a single use: 
//    - daphne.ewSqrt
%8 = "daphne.ewSqrt"(%7) : (!daphne.Matrix<?x?xsi64>) -> !daphne.Matrix<?x?xf64>
//Visiting op 'daphne.ewSqrt' with 1 operands:
//  - Operand produced by operation 'daphne.ewAdd0x5624a2e1eb20'
//Has 1 results:
...
module {
  func.func @main() {
    ...
    %2 = "daphne.fill"(%1, %0, %0) : (si64, index, index) -> !daphne.Matrix<?x?xsi64>
    %3 = "daphne.ewAdd"(%2, %1) : (!daphne.Matrix<?x?xsi64>, si64) -> !daphne.Matrix<?x?xsi64>
    %4 = "daphne.ewSqrt"(%3) : (!daphne.Matrix<?x?xsi64>) -> !daphne.Matrix<?x?xf64>
    "daphne.return"() : () -> ()
  }
}
...
module {
  func.func @main() {
    %0 = "daphne.constant"() {value = 2 : index} : () -> index
    %1 = "daphne.constant"() {value = 1 : si64} : () -> si64
    %2 = "daphne.fill"(%1, %0, %0) : (si64, index, index) -> !daphne.Matrix<2x2xsi64>
    %3 = "daphne.ewAdd"(%2, %1) : (!daphne.Matrix<2x2xsi64>, si64) -> !daphne.Matrix<2x2xsi64>
    %4 = "daphne.ewSqrt"(%3) : (!daphne.Matrix<2x2xsi64>) -> !daphne.Matrix<2x2xf64>
    "daphne.return"() : () -> ()
  }
}
...
module {
  func.func @main() {
    ...
    %2 = "daphne.fill"(%1, %0, %0) : (si64, index, index) -> !daphne.Matrix<2x2xsi64>
    %3 = "daphne.ewAdd"(%2, %1) : (!daphne.Matrix<2x2xsi64>, si64) -> !daphne.Matrix<2x2xsi64>
    %4 = "daphne.cast"(%3) : (!daphne.Matrix<2x2xsi64>) -> !daphne.Matrix<2x2xf64>
    %5 = "daphne.ewSqrt"(%4) : (!daphne.Matrix<2x2xf64>) -> !daphne.Matrix<2x2xf64>
    "daphne.return"() : () -> ()
  }
}
...
module {
  func.func @main() {
    ...
    %2 = "daphne.constant"() {value = 140721340167472 : ui64} : () -> ui64
    %3 = "daphne.createDaphneContext"(%2) : (ui64) -> !daphne.DaphneContext
    %4 = "daphne.fill"(%0, %1, %1) : (si64, index, index) -> !daphne.Matrix<2x2xsi64>
    %5 = "daphne.ewAdd"(%4, %0) : (!daphne.Matrix<2x2xsi64>, si64) -> !daphne.Matrix<2x2xsi64>
    "daphne.decRef"(%4) : (!daphne.Matrix<2x2xsi64>) -> ()
    %6 = "daphne.cast"(%5) : (!daphne.Matrix<2x2xsi64>) -> !daphne.Matrix<2x2xf64>
    "daphne.decRef"(%5) : (!daphne.Matrix<2x2xsi64>) -> ()
    %7 = "daphne.ewSqrt"(%6) : (!daphne.Matrix<2x2xf64>) -> !daphne.Matrix<2x2xf64>
...
module {
  func.func @main() {
    ...
    %4 = "daphne.call_kernel"(%0, %1, %1, %3) {callee = "_fill__DenseMatrix_int64_t__int64_t__size_t__size_t"} : (si64, index, index, !daphne.DaphneContext) -> !daphne.Matrix<2x2xsi64>
    %5 = "daphne.call_kernel"(%4, %0, %3) {callee = "_ewAdd__DenseMatrix_int64_t__DenseMatrix_int64_t__int64_t"} : (!daphne.Matrix<2x2xsi64>, si64, !daphne.DaphneContext) -> !daphne.Matrix<2x2xsi64>
    "daphne.call_kernel"(%4, %3) {callee = "_decRef__Structure"} : (!daphne.Matrix<2x2xsi64>, !daphne.DaphneContext) -> ()
    %6 = "daphne.call_kernel"(%5, %3) {callee = "_cast__DenseMatrix_double__DenseMatrix_int64_t"} : (!daphne.Matrix<2x2xsi64>, !daphne.DaphneContext) -> !daphne.Matrix<2x2xf64>
    "daphne.call_kernel"(%5, %3) {callee = "_decRef__Structure"} : (!daphne.Matrix<2x2xsi64>, !daphne.DaphneContext) -> ()
    %7 = "daphne.call_kernel"(%6, %3) {callee = "_ewSqrt__DenseMatrix_double__DenseMatrix_double"} : (!daphne.Matrix<2x2xf64>, !daphne.DaphneContext) -> !daphne.Matrix<2x2xf64>
    "daphne.call_kernel"(%7, %3) {callee = "_decRef__Structure"} : (!daphne.Matrix<2x2xf64>, !daphne.DaphneContext) -> ()
...
module {
  ...
  llvm.func @_ewAdd__DenseMatrix_int64_t__DenseMatrix_int64_t__int64_t(!llvm.ptr<ptr<i1>>, !llvm.ptr<i1>, i64, !llvm.ptr<i1>)
  llvm.func @_fill__DenseMatrix_int64_t__int64_t__size_t__size_t(!llvm.ptr<ptr<i1>>, i64, i64, i64, !llvm.ptr<i1>)
  ...
  llvm.func @main() attributes {llvm.emit_c_interface} {
    ...
    %2 = llvm.mlir.constant(140721340167472 : ui64) : i64
    ...
    llvm.call @_fill__DenseMatrix_int64_t__int64_t__size_t__size_t(%8, %0, %1, %1, %6) : (!llvm.ptr<ptr<i1>>, i64, i64, i64, !llvm.ptr<i1>) -> ()
    ...
    llvm.call @_ewAdd__DenseMatrix_int64_t__DenseMatrix_int64_t__int64_t(%12, %10, %0, %6) : (!llvm.ptr<ptr<i1>>, !llvm.ptr<i1>, i64, !llvm.ptr<i1>) -> ()
    ...
    llvm.call @_decRef__Structure(%24, %6) : (!llvm.ptr<i1>, !llvm.ptr<i1>) -> ()
